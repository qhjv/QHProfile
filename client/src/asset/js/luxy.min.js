/*! luxy.js v0.1.0 | (c) 2018 Mineo Okuda | MIT License | git+ssh://git@github.com:min30327/luxy.js.git */ ! function(t, e) {
    "use strict";
    ...
    return s.prototype = {
        ...
        init: function(e) {
            if (this.settings = function() {
                    for (var t = {}, e = 0, i = arguments.length, s = function(e) {
                            for (var i in e) e.hasOwnProperty(i) && (t[i] = e[i])
                        }; e < i; e++) s(arguments[e]);
                    return t
                }(t, e || {}), this.wrapper = document.querySelector(this.settings.wrapper), "undefined" === this.wrapper) return !1;
        ...
        resize: function() {
            this.windowHeight = window.innerHeight || document.documentElement.clientHeight || 0, parseInt(this.wrapper.clientHeight) != parseInt(document.body.style.height) && (document.body.style.height = this.wrapper.clientHeight + "px"), this.resizeId = e(this.resize.bind(this))
        },
